...
const routes = [
  {
    ...
    children: [
      { path: '', name: '포슬립 계산기 허브', component: () => import('pages/IndexPage.vue'),
        meta: { 
          help: 'exp 계산부터 개체값 측정까지! 당신의 포켓몬을 완벽 분석해드립니다',
    ...
    children: [
      { path: '', name: '이브이 최적 진화 찾기', component: () => import('pages/EeveelutionPage.vue'),
        meta: {
          ...
          link: 'https://extrabottle.github.io/pkmSleepCalc/#/eeveelution'
        }
       }      
    ],
  },
    ...
    children: [
      { path: '', name: '포슬립 exp 계산기', component: () => import('pages/ExpCalcPage.vue'),
        meta: {
          ...
          link: 'https://extrabottle.github.io/pkmSleepCalc/#/expcalc'
        }
       }      
    ],
  },
    ...
    children: [
      { path: '', name: '포슬립 생산량 계산기', component: () => import('pages/ProdCalcPage.vue'),
        meta: {
          ...
          link: 'https://extrabottle.github.io/pkmSleepCalc/#/prodcalc'
        }
       },
    ...
    children: [
      { path: '', name: '포슬립 개체값 평가', component: () => import('pages/RatePage.vue'),
        meta: {
          ...
          link: 'https://extrabottle.github.io/pkmSleepCalc/#/rate'
        }
       }
    ],
  },
    ...
    children: [
      { path: '', name: '포슬립 비밀 도감', component: () => import('pages/SleepDexPage.vue'),
        meta: {
          ...
          link: 'https://extrabottle.github.io/pkmSleepCalc/#/dex'
        }
       }
    ],
  },
